...
def add(
	...
	username: str | None = typer.Option(None, "--username", help="Usuario de SQL Server"),
	password: str | None = typer.Option(None, "--password", help="Contraseña de SQL Server"),
) -> None:
...
@app.command()
def rm(
	name: str | None = typer.Option(None, "--name", help="Nombre de la conexión a eliminar"),
) -> None:
